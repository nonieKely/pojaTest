...
import com.poja.demo.conf.FacadeIT;
import com.poja.demo.endpoint.event.consumer.model.ConsumableEvent;
import com.poja.demo.endpoint.event.consumer.model.ConsumableEventTyper;
import com.poja.demo.endpoint.event.consumer.model.TypedEvent;
import com.poja.demo.endpoint.event.model.UuidCreated;
...
public class ConsumableEventTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent = new TypedEvent("com.poja.demo.endpoint.event.model.UuidCreated", payload);
  ...
  void to_acknowledgeable_typed_event_ko() throws JsonProcessingException {
    ...
    var validTypedEvent = new TypedEvent("com.poja.demo.endpoint.event.model.UuidCreated", payload);
