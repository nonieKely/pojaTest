package com.poja.demo.endpoint.event.consumer;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.poja.demo.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.poja.demo.service.event." + typeNameAsArray[typeNameAsArray.length - 1] + "Service";
  }
