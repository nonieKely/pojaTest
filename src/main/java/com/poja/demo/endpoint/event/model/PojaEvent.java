package com.poja.demo.endpoint.event.model;

import static com.poja.demo.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import com.poja.demo.PojaGenerated;
import com.poja.demo.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "com.poja.demo.event1";
    return "com.poja.demo.event2";
  }
}
